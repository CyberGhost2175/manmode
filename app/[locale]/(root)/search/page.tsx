...
const sortOrders = [
  { value: 'price-low-to-high', name: 'цена по возрастанию' },
  { value: 'price-high-to-low', name: 'цена по убыванию' },
  { value: 'newest-arrivals', name: 'новая коллекция' },
  { value: 'avg-customer-review', name: 'с большим кол-вом отзывов' },
  { value: 'best-selling', name: 'бестселлеры' },
]
...
export default async function SearchPage(props: {
  ...
  return (
    <div >
      <div className='my-2 bg-border md:border-b p-3 flex-between flex-col md:flex-row '>
      ...
      <div className='bg-border grid md:grid-cols-5 md:gap-4 w-full p-3' >
