            ...
            <CardContent className='p-4'>
                ...
                {isPaymentMethodSelected && isAddressSelected && (
                    <div>
                        ...
                        <p className='text-xs text-center py-2'>
                            Размещая заказ вы соглашаетесь с  {site.name}s{' '}
                            <Link href='/page/privacy-policy'>{t('privacyPolicy')}</Link> и
                                  ...
                                  calculateFutureDate(
                                      availableDeliveryDates[deliveryDateIndex!]
                                          .daysToDeliver
                                            ...
                                            {t('condition')} {timeUntilMidnight().hours}  {t('hours')}
                                             и {timeUntilMidnight().minutes} {t('minutes')}.
                                        </p>
                                        <div className='grid md:grid-cols-2 gap-6'>
                                            ...
                                            <div>
                                                <div className=' font-bold'>
                                                    <p className='mb-2'> {t('shippingSpeed')}</p>
                                ...
                                <CardContent
                                    ...
                                    <div className='flex-1'>
                                        <p className='font-bold text-lg'>
                                            {t('orderSummary')}: <ProductPrice price={totalPrice} plain/>
                                        </p>
                                        <p className='text-xs'>
                                            {' '}
                                            {t('byPlacing')} {
