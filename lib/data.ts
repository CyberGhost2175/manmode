...
const reviews = [
    {
        ...
        comment: 'Очень разочарован. Товар сломался после нескольких использований. Не стоит своих денег.',
    },
    {
        rating: 2,
        title: 'Не оправдал ожиданий',
        comment: 'Материал кажется дешевым, да и посадка неудобная. Вряд ли куплю снова.',
    },
    {
        rating: 2,
        title: 'Есть над чем работать',
        comment: 'Выглядит неплохо, но не соответствует заявленным характеристикам. Нужно дорабатывать.',
    },
    {
        rating: 3,
        title: 'Средний уровень',
        comment: 'Качество хорошее, но есть недочёты. Можно улучшить некоторые детали.',
    },
    {
        rating: 3,
        title: 'Не плохо, но...',
        comment: 'Функционирует, но не так, как хотелось бы. Ожидал лучшего качества.',
    },
    {
        rating: 3,
        title: 'Достойный вариант',
        comment: 'В целом товар хороший, но не без недостатков. Соотношение цена-качество приемлемое.',
    },
    {
        rating: 4,
        title: 'Хороший выбор',
        comment: 'Отличное соотношение цены и качества! Есть небольшие минусы, но в целом доволен.',
    },
    {
        rating: 4,
        title: 'Стоит своих денег',
        comment: 'Качественный товар, стоит своих денег. Возможно, куплю снова.',
    },
    {
        rating: 4,
        title: 'Прекрасное приобретение!',
        comment: 'Оправдал все мои ожидания! Качество, дизайн и удобство на высоте.',
    },
    {
        rating: 4,
        title: 'Лучше, чем ожидал!',
        comment: 'Прекрасное качество, добротные материалы и отличная сборка. Рекомендую!',
    },
    {
        rating: 5,
        title: 'Идеальная покупка!',
        comment: 'Лучшее, что я покупал за последнее время! Всё работает отлично.',
    },
    {
        rating: 5,
        title: 'Рекомендую к покупке',
        comment: 'Отличный товар! Стильный, удобный и качественный. Полностью доволен!',
    },
    {
        rating: 5,
        title: 'То, что искал!',
        comment: 'Полностью соответствует описанию! Качество даже выше, чем ожидал.',
    },
    {
        rating: 5,
        title: 'Лучший выбор!',
        comment: 'Всё на высшем уровне: материалы, сборка и функциональность. Стоит своих денег!',
    },
    {
        rating: 5,
        title: 'Ожидания оправданы!',
        comment: 'Стильный, прочный и удобный! Покупкой остался полностью доволен.',
    },
];
    ...
    webPages: [
        {
            title: 'О нас',
            slug: 'about-us-ru',
            content: `Добро пожаловать в ManMode– место, где стиль, качество и надежность встречаются в одном удобном магазине. Мы создали эту платформу, чтобы предложить вам первоклассные товары по доступным ценам, обеспечивая при этом комфортный и безопасный процесс покупок.

В ManMode мы ценим каждого клиента и стремимся к совершенству во всем – от разнообразия ассортимента до уровня сервиса. Наша команда тщательно отбирает товары, чтобы удовлетворить ваши потребности, будь то повседневные вещи или эксклюзивные предложения. Мы гарантируем быструю доставку, удобные способы оплаты и отзывчивую поддержку, чтобы ваши покупки были приятными и беспроблемными.

Мы продолжаем развиваться, внедряя новые технологии и расширяя выбор товаров, чтобы превзойти ваши ожидания. Спасибо, что выбираете ManMode– мы рады быть частью вашего стиля и готовы предложить только лучшее
...
We also provide helpful resources such as order tracking, product guides, and FAQs to assist you with common inquiries. Your satisfaction is our priority, and we’re here to resolve any issues quickly and efficiently. Thank you for choosing us!`,
    ...
    carousels: [
        ...
        {
            title: 'Only exclusive and modern clothes',
            buttonCaption: 'Shop Now',
    ...
    settings: [
        {
            ...
            site: {
                name: 'ManMode',
                description:
                    'ManMode -место стиля и движений !',
                keywords: 'мужская одежда ,мужской магазин',
                url: 'https://next-mongo-ecommerce-final.vercel.app',
                logo: '/icons/logo.svg',
                slogan: 'ManMode - это про стиль ',
                author: 'ManMode group.',
                copyright: '2025',
                email: 'manmode@gmail.com',
                address: 'ул. Кабанбай Батыра 76 ,Казахстан , Астана',
                phone: '+1 (123) 456-7890',
            },
            carousels: [
                {
            ...
            availableCurrencies: [
                ...
                {name: 'Казахстанский тенге', code: 'KZT', symbol: '₸', convertRate: 1},
            ],
            defaultCurrency: 'KZT',
            availablePaymentMethods: [
                {name: 'PayPal', commission: 0},
                {name: 'Stripe', commission: 0},
                {name: 'Наличные при получении', commission: 0},
            ],
