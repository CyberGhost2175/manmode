...
const data: Data = {
    ...
    carousels: [
        {
            title: 'Популярная модель на летний сезон ',
        ...
        {
            title: 'Поступление новой коллекции футболок',
            buttonCaption: 'Заказать',
        ...
        {
            title: 'Подберем аксессуар под ваш стиль',
            buttonCaption: 'Больше',
